...
echo"<div id='infoso'><h1 id='titre_info'>".$etablissement_lib."</h1>";
        ...
        <li><b>Diplome : </b>".$typ_diplome_lib."</li>
        <li><b>Academie : </b>".url_decode($_GET["ins_lib"])."</li>
        <li><b>Code : </b>".$name."</li>
        <li><b>Cycle : </b>".url_decode($_GET["cursus_lmd_lib"])."</li>
        <li><b>Année : </b>".url_decode($_GET["niveau_lib"])."</li>
        <li><b>Effectif : </b>".$effectif_total."</li>
        <li><b>Wikidata : </b>".$Wikidata."</li><br>
        <hr>
        </div>";
        //,$value4["fields"]["coordonnees"][0],$value4["fields"]["coordonnees"][1]

echo url_decode($_GET["etablissement"]);
echo "<br>";
